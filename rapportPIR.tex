...
\usepackage{fmtcount}
\usepackage{tikz}
\usetikzlibrary{positioning, shapes, arrows.meta, matrix, decorations.pathreplacing, calc}
\usepackage{wrapfig}
\usepackage{lipsum}
...
\begin{itemize}
	\item Let $N$ represent the number of drones in the simulation.
	\item Let $p_i = (x_i, y_i)$ represent the position of drone number i.
	\item Let $\phi_i$ represent the heading of drone number i.
	\item Let $v_i$ represent the speed of drone number i.
\end{itemize}
...
\begin{align}
	c_{\text{tot}} = ~& c_{\text{effort}} \times W_{\text{effort}} \nonumber \\
				   &+ c_{\text{disp}} \times W_{\text{disp}} \nonumber\\
				   &+ c_{\text{pol}} \times W_{\text{pol}} \nonumber\\
				   &+ c_{\text{coll}} \times W_{\text{coll}} \nonumber\\
				   &+ c_{\text{mill}} \times W_{\text{mill}} \nonumber\\
				   &+ c_{\text{explo}} \times W_{\text{explo}}
\end{align}
